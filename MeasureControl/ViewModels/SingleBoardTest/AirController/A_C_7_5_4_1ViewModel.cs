...
{
    public sealed class A_C_7_5_4_1ViewModel : BindableBase, IDisposable
    {
        ...
        private static readonly (string In, string Out, int Slot) MatrixPointSig = ("I1", "O23", MatrixSlotSig);
