...
namespace MeasureControl.ViewModels.SingleBoardTest.AirController
{
    public sealed class A_C_6_17_1_2ViewModel : BindableBase, IDisposable
    {
        ...
        public A_C_6_17_1_2ViewModel()
        {
            ...
            RunDirHighAndMeasureCommand = new DelegateCommand(async () => await SendDirAndMeasureAsync(DirHighCommand8, isHigh: true, title: "DIR引脚高电平"));
            RunDirLowAndMeasureCommand = new DelegateCommand(async () => await SendDirAndMeasureAsync(DirLowCommand8, isHigh: false, title: "DIR引脚低电平"));
        }
        ...
        private async Task DisconnectMatrixAsync(CancellationToken token)
        {
            ...
            try
            {
                if (_matrixHighRouted || _matrixLowRouted)
                {
                    ...
                    {
                        svc.DisconnectNodesAsync("I0", "O15", 9, MatrixIp),
