...
namespace MeasureControl.ViewModels.SingleBoardTest.AirController
{
    public class R_6_8_3ViewModel : BindableBase, IDisposable
    {
        ...
        private const string ResistorChannelId = "RO5";
        ...
        private async Task OnTestControllerTemperatureAsync()
        {
            ...
            try
            {
                AddLog($"[{DateTime.Now:HH:mm:ss}] 测试：AB_CARTS_Temperature，TX={ControllerTemperatureTestTxChannel}, Label=0x{DefaultLabel:X2}");
