...
{
    public sealed class A_C_7_4_1_2ViewModel : BindableBase, IDisposable
    {
        ...
        private const string Slot2601_2_J96_Out = "O12";
        private const string Slot2601_2_J98_Out = "O13";
        ...
        private bool _matrixRouted2601_2_J96;
        private bool _matrixRouted2601_2_J98;
        ...
        private async Task<(bool ok, double? phaseDeg)> MeasurePhaseDiffDegAsync(CancellationToken token)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    AddLog("路由测相位：J96->CH1, J98->CH2");

                    okJ96 = await matrix.ConnectNodesAsync(Slot2601_2_In, Slot2601_2_J96_Out, Chassis2Slot2601_2, DefaultMatrixIpAddress, DefaultMatrixTcpBasePort).ConfigureAwait(false);
                    okJ98 = await matrix.ConnectNodesAsync(Slot2601_2_In, Slot2601_2_J98_Out, Chassis2Slot2601_2, DefaultMatrixIpAddress, DefaultMatrixTcpBasePort).ConfigureAwait(false);
                    ...
                    _matrixRouted2601_2_J96 = okJ96;
                    _matrixRouted2601_2_J98 = okJ98;
                    _matrixRouted2601_1_Ch1 = okCh1;
                    _matrixRouted2601_1_Ch2 = okCh2;
                    _isMatrixRouted = okJ96 && okJ98 && okCh1 && okCh2;

                    AddLog($"路由结果：2601(2)J96={(okJ96 ? "OK" : "FAIL")}, J98={(okJ98 ? "OK" : "FAIL")}; 2601(1)CH1={(okCh1 ? "OK" : "FAIL")}, CH2={(okCh2 ? "OK" : "FAIL")}");
                    if (!_isMatrixRouted)
                        return (false, null);
        ...
        {
            if (!_isMatrixRouted && !_matrixRouted2601_2_J96 && !_matrixRouted2601_2_J98 && !_matrixRouted2601_1_Ch1 && !_matrixRouted2601_1_Ch2)
                return;
            ...
            try
            {
                if (_matrixRouted2601_2_J98)
                    _ = await matrix.DisconnectNodesAsync(Slot2601_2_In, Slot2601_2_J98_Out, Chassis2Slot2601_2, DefaultMatrixIpAddress, DefaultMatrixTcpBasePort).ConfigureAwait(false);
            }
            catch { }

            try
            {
                if (_matrixRouted2601_2_J96)
                    _ = await matrix.DisconnectNodesAsync(Slot2601_2_In, Slot2601_2_J96_Out, Chassis2Slot2601_2, DefaultMatrixIpAddress, DefaultMatrixTcpBasePort).ConfigureAwait(false);
            }
            catch { }

            _isMatrixRouted = false;
            _matrixRouted2601_2_J96 = false;
            _matrixRouted2601_2_J98 = false;
