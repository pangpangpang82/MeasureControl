...
using MeasureControl.Simulations.A_C_6_5_2_2;
...
namespace MeasureControl.ViewModels.SingleBoardTest.AirController
{
    public sealed class A_C_6_5_2_2ViewModel : BindableBase, IDisposable
    {
        ...
        private readonly A_C_6_5_2_2Simulation _simulation = new A_C_6_5_2_2Simulation();
        ...
        private async Task OnSendReceiveAsync()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    AddLog($"[{DateTime.Now:HH:mm:ss}] 发送接收指令：{FormatBytes(AbA429Arx1ReceiveCommand8)}");
                    await _simulation.SendBenchCommandOnlyAsync(FixedReceiveTxChannel, AbA429Arx1ReceiveCommand8, msg => AddLog(msg), token);
