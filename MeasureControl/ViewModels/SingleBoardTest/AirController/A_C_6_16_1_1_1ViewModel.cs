...
namespace MeasureControl.ViewModels.SingleBoardTest.AirController
{
    public sealed class A_C_6_16_1_1_1ViewModel : BindableBase, IDisposable
    {
        ...
        private static readonly byte[] EnterAtpOk8 = { 0x30, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00 }; // send-only
        private static readonly byte[] ExitAtpCommand8 = { 0x30, 0x02, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00 };
        private static readonly byte[] ExitAtpOk8 = { 0x30, 0x02, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00 }; // send-only
        ...
        private async Task RunAutoTestAsync()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (!await AutoStepAsync(Speed1Command8, Speed1Command8, "AB_MOTORTCV_SPEED1", token, noReadback: true))
                        failures.Add("AB_MOTORTCV_SPEED1失败");
