...
namespace MeasureControl.ViewModels.SingleBoardTest.AirController
{
    public class R_6_8_9ViewModel : BindableBase, IDisposable
    {
        ...
        private static readonly byte[] AbBtsTemperature = { 0x07, 0x01, 0x09, 0x01, 0x00, 0x00, 0x00, 0x00 };
        private static readonly byte[] TemperatureTelemetryCommand = { 0x07, 0x01, 0x09, 0x02, 0x00, 0x00, 0x00, 0x00 };
        ...
        private async Task<bool> EnsureResistorReadyAsync(bool enableLog = true)
        {
            ...
            try
            {
                ...
                int foundCount = 0;
                const int targetBoardIndex = 2; // 使用第2块电阻板卡
