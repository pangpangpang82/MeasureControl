...
{
    public sealed class A_C_7_4_3_2ViewModel : BindableBase, IDisposable
    {
        ...
        private const string Slot2601_2_J158_Out = "O16";
        private const string Slot2601_2_J160_Out = "O17";
        ...
        private bool _matrixRouted2601_2_J158;
        private bool _matrixRouted2601_2_J160;
        ...
        private async Task StartAutoTestAsync()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var passAll = pass2 && pass4;
                    SetOverall(passAll ? "PASS" : "FAIL");
                    AddLog($"========== 自动测试结束，总结果: {(passAll ? "PASS" : "FAIL")} ==========");
                }
        ...
        private async Task SendDirLowAsync()
        {
            ...
            try
            {
                ...
                try
                {
                    await SendFpgaCommandAsync(DirLowCommand, "DIR低电平", CancellationToken.None).ConfigureAwait(false);
                }
                finally
                {
                    IsBusy = false;
        ...
        private async Task<(bool ok, double? phaseDeg)> MeasurePhaseDiffDegAsync(CancellationToken token)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    AddLog("路由测相位：J158->CH1, J160->CH2");

                    okJ158 = await matrix.ConnectNodesAsync(Slot2601_2_In, Slot2601_2_J158_Out, Chassis2Slot2601_2, DefaultMatrixIpAddress, DefaultMatrixTcpBasePort).ConfigureAwait(false);
                    okJ160 = await matrix.ConnectNodesAsync(Slot2601_2_In, Slot2601_2_J160_Out, Chassis2Slot2601_2, DefaultMatrixIpAddress, DefaultMatrixTcpBasePort).ConfigureAwait(false);
                    ...
                    _matrixRouted2601_2_J158 = okJ158;
                    _matrixRouted2601_2_J160 = okJ160;
                    _matrixRouted2601_1_Ch1 = okCh1;
                    _matrixRouted2601_1_Ch2 = okCh2;
                    _isMatrixRouted = okJ158 && okJ160 && okCh1 && okCh2;

                    AddLog($"路由结果：2601(2)J158={(okJ158 ? "OK" : "FAIL")}, J160={(okJ160 ? "OK" : "FAIL")}; 2601(1)CH1={(okCh1 ? "OK" : "FAIL")}, CH2={(okCh2 ? "OK" : "FAIL")}");
                    if (!_isMatrixRouted)
                        return (false, null);
        ...
        {
            if (!_isMatrixRouted && !_matrixRouted2601_2_J158 && !_matrixRouted2601_2_J160 && !_matrixRouted2601_1_Ch1 && !_matrixRouted2601_1_Ch2)
                return;
            ...
            try
            {
                if (_matrixRouted2601_2_J160)
                    _ = await matrix.DisconnectNodesAsync(Slot2601_2_In, Slot2601_2_J160_Out, Chassis2Slot2601_2, DefaultMatrixIpAddress, DefaultMatrixTcpBasePort).ConfigureAwait(false);
            }
            catch { }

            try
            {
                if (_matrixRouted2601_2_J158)
                    _ = await matrix.DisconnectNodesAsync(Slot2601_2_In, Slot2601_2_J158_Out, Chassis2Slot2601_2, DefaultMatrixIpAddress, DefaultMatrixTcpBasePort).ConfigureAwait(false);
            }
            catch { }

            _isMatrixRouted = false;
            _matrixRouted2601_2_J158 = false;
            _matrixRouted2601_2_J160 = false;
