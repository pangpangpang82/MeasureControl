...
namespace MeasureControl.ViewModels.SingleBoardTest.AirController
{
    public sealed class A_C_6_5_2_4ViewModel : BindableBase, IDisposable
    {
        ...
        private static readonly byte[] AbA429Arx3ReceiveCommand8 = { 0x04, 0x02, 0x04, 0x01, 0x00, 0x00, 0x00, 0x00 };
        ...
        private async Task OnSendReceiveAsync()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    await _simulation.SendBenchCommandOnlyAsync(FixedReceiveTxChannel, AbA429Arx3ReceiveCommand8, msg => AddLog(msg), token);
