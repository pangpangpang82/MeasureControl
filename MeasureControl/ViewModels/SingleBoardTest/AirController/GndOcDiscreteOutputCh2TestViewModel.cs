...
namespace MeasureControl.ViewModels.SingleBoardTest.AirController
{
    public class GndOcDiscreteOutputCh2TestViewModel : BindableBase
    {
        ...
        public string PageTitle => "6.15.1.2GND/OC型离散输出通道2输出测试";
        ...
        {
            // (2) 429发送测试指令A_GNDDSO2_GNDTEST 0x09 01 02 01 00 00 00 00
            try { await _arinc.ClearRxFifoAsync(RxChannel); } catch { }
            ...
            var loopResp = await _arinc.WaitBenchResponse8Async(
                RxChannel,
                b => b != null && b.Length == 8 && b[0] == 0x09 && b[1] == 0x01 && b[2] == 0x02 && b[3] == 0x04,
                timeoutMs: 2000,
                msg => AddLog(msg),
                token);
        ...
        {
            // (6) 429发送测试指令A_GNDDSO2_OCTEST 0x09 01 02 06 00 00 00 00
            try { await _arinc.ClearRxFifoAsync(RxChannel); } catch { }
            await Task.Delay(20, token);
            ...
            var loopResp = await _arinc.WaitBenchResponse8Async(
                RxChannel,
                b => b != null && b.Length == 8 && b[0] == 0x09 && b[1] == 0x01 && b[2] == 0x02 && b[3] == 0x09,
                timeoutMs: 2000,
                msg => AddLog(msg),
                token);
