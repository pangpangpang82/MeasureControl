...
using MeasureControl.Simulations.A_C_6_17_4_2;

namespace MeasureControl.ViewModels.SingleBoardTest.AirController
{
    public sealed class A_C_6_17_4_2ViewModel : BindableBase, IDisposable
    {
        ...
        private readonly A_C_6_17_4_2Simulation _simulation = new A_C_6_17_4_2Simulation();
        ...
        private async Task<bool> EnsureMatrixRoutedAsync(CancellationToken token)
        {
            ...
            if (_matrixRouted)
                await Task.Delay(200, token);
            _ = token;
            AddLog($"[{DateTime.Now:HH:mm:ss}] 矩阵开关通路(示波器): I1->O21 slot=9 + I0->O8 slot=4, ip={MatrixIp}, ok={_matrixRouted}");
