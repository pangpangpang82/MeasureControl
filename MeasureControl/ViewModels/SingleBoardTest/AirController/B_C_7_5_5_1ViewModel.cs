...
{
    public sealed class B_C_7_5_5_1ViewModel : BindableBase, IDisposable
    {
        ...
        public B_C_7_5_5_1ViewModel()
        {
            ...
            Step2Set0mACommand = new DelegateCommand(async () => await SendSetCurrentAndUpdateAsync(CurrentSet0mA));
            ...
            Step6Set400mACommand = new DelegateCommand(async () => await SendSetCurrentAndUpdateAsync(CurrentSet400mA));
        ...
        private async Task SendSetCurrentAndUpdateAsync(int currentmA)
        {
