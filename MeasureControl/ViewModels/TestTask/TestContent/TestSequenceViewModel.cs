...
namespace MeasureControl.ViewModels
{
    ...
    /// 测试序列的ViewModel
    /// </summary>
    public class TestSequenceViewModel : BindableBase, INavigationAware, IDisposable
    {
        ...
        public TestSequenceViewModel(IRegionManager regionManager, IEventAggregator eventAggregator)
        {
        ...
        private void OnCloseInRegion()
        {
            ...
            {
                // 构建完整的pageKey: TestSequence_任务名-配置表名
                string pageKey = $"TestSequence_{TestTaskName}-{ConfigTabelName}";
