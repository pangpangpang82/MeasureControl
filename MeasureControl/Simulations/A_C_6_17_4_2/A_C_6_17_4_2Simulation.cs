...
namespace MeasureControl.Simulations.A_C_6_17_4_2
{
    public sealed class A_C_6_17_4_2Simulation : ARINC429SimulationBase
    {
        ...
        private static readonly byte[] EnterAtpOk8 = { 0x30, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00 };
        private static readonly byte[] ExitAtpCommand8 = { 0x30, 0x02, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00 };
        private static readonly byte[] ExitAtpOk8 = { 0x30, 0x02, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00 };

        private static readonly byte[] DirHighCommand8 = { 0x22, 0x04, 0x03, 0x01, 0x00, 0x00, 0x00, 0x00 };
        private static readonly byte[] DirLowCommand8 = { 0x22, 0x04, 0x03, 0x02, 0x00, 0x00, 0x00, 0x00 };
                ...
                try
                {
                    ...
                    if (list != null && list.Count > 0)
                    {
                        foreach (var item in list)
                        {
                            ...
                            if (cmd8.SequenceEqual(DirHighCommand8) || cmd8.SequenceEqual(DirLowCommand8))
                            {
