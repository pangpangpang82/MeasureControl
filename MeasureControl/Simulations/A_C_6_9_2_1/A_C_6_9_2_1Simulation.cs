...
namespace MeasureControl.Simulations.A_C_6_9_2_1
{
    public sealed class A_C_6_9_2_1Simulation : ARINC429SimulationBase
    {
        ...
        // 6.9.2 CAB_VENTS 温度测试与遥测编码（07 02 02 xx）
        private static readonly byte[] PressureTestCommand8          = { 0x07, 0x02, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00 };
        private static readonly byte[] PressureTelemetryTemplate8    = { 0x07, 0x02, 0x02, 0x02, 0x00, 0x00, 0x00, 0x00 };
        private static readonly byte[] PressureTelemetryRawTemplate8 = { 0x07, 0x02, 0x02, 0x03, 0x00, 0x00, 0x00, 0x00 };

        private static readonly byte[] PressureTelemetryPrefix4    = { 0x07, 0x02, 0x02, 0x02 };
        private static readonly byte[] PressureTelemetryRawPrefix4 = { 0x07, 0x02, 0x02, 0x03 };
