...
namespace MeasureControl.Simulations.A_C_6_15_1_1
{
    public sealed class A_C_6_15_1_1Simulation : ARINC429SimulationBase
    {
                ...
                try
                {
                    ...
                    if (list != null && list.Count > 0)
                    {
                        foreach (var item in list)
                        {
                            ...
                            if (cmd8.SequenceEqual(Pwm100Command8) || cmd8.SequenceEqual(Pwm50Command8) || cmd8.SequenceEqual(Pwm0Command8))
                            {
